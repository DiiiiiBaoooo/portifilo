...
const Developer = ({ animationName = 'idle', ...props }) => {
  ...
  useEffect(() => {
    const validAnimationName = actions[animationName] ? animationName : 'idle';
    console.log('Playing animation:', validAnimationName);
    console.log('Available actions:', Object.keys(actions));
    actions[validAnimationName].reset().fadeIn(0.5).play();
    return () => {
      if (actions[validAnimationName]) {
        actions[validAnimationName].fadeOut(0.5);
      }
    };
